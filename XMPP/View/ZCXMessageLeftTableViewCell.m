...
@interface ZCXMessageLeftTableViewCell()

@property (nonatomic, strong) UIImageView *userImage;
@property (nonatomic, strong) UITextView *contentTV;

@end
@implementation ZCXMessageLeftTableViewCell
...
-(void)createUI{
    ...
    _userImage.image = [UIImage imageNamed:@"goods_info_service"];
